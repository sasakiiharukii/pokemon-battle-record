...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('paties', function (Blueprint $table) {
            ...
            $table->foreignId('pokemon1_item_id')->nullable()->constrained('items');
            $table->foreignId('pokemon2_item_id')->nullable()->constrained('items');
            $table->foreignId('pokemon3_item_id')->nullable()->constrained('items');
            $table->foreignId('pokemon4_item_id')->nullable()->constrained('items');
            $table->foreignId('pokemon5_item_id')->nullable()->constrained('items');
            $table->foreignId('pokemon6_item_id')->nullable()->constrained('items');
            $table->timestamps();
        });
    }
